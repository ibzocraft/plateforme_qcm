...
<header class="d-flex align-items-center justify-content-between border-bottom px-4 py-2 mx-3 mt-3 rounded-4 bg-theme position-sticky top-0" style="z-index: 500;">
    ...
    <div class="d-flex flex-grow-1 justify-content-end gap-4">
        <div class="d-flex align-items-center gap-4">
            ...
            <a class="text-dark small fw-medium text-decoration-none <?php echo str_contains($current_page, "dashboard.php") ? "active" : ""; ?>" href="/pages/portail/dashboard.php">Dashboard</a>
            <a class="text-dark small fw-medium text-decoration-none <?php echo str_contains($current_page, "qcms/") ?"active" : ""; ?>" href="/pages/portail/qcms/qcms.php">QCMs</a>
            <a class="text-dark small fw-medium text-decoration-none <?php echo str_contains($current_page, "statistiques.php") ? "active" : ""; ?>" href="/pages/portail/statistiques.php">Statistiques</a>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu pb-1">
                <li><a class="dropdown-item" href="/pages/portail/profil.php">Mon Profil</a></li>
