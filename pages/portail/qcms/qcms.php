...
<div class="container-fluid p-4 mb-5">
    <div class="row p-4">
        <div class="col-12">
            <p class="text-custom-dark tracking-light fs-2 fw-bold leading-tight min-w-72">Liste des QCMs</p>
            <p class="text-muted">Voici la liste de tous les QCMs disponibles. Commencez un nouveau QCM ou revoyez vos résultats passés.</p>
        </div>
    </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            ?>
                                <div class="mt-auto">
                                    ...
                                    <a href="#" class="btn btn-secondary w-100">Revoir</a>
                                </div>
                            <?php else: ?>
                                <div class="mt-auto">
