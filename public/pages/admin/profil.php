        ...
        <div class="row">
            <div class="col-md-6">
                <div class="bg-theme-accent p-4 rounded-4 mb-4">
                    ...
                    <form action="/profil/update_info" method="post" class="needs-validation" novalidate>
                        <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="bg-theme-accent p-4 rounded-4 mb-4">
                    ...
                    <form action="/profil/update_password" method="post" class="needs-validation" novalidate>
                        <div class="mb-3">
