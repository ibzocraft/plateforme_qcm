        ...
        <div class="d-flex flex-column">
            <div class="px-4 py-3 spawn-slide-down">
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" id="searchEtudiant" class="form-control bg-theme-accent border-start-0" placeholder="Rechercher des étudiants par numéro, nom, email ou classe..." aria-label="Username" aria-describedby="addon-wrapping">
                </div>
            </div>
                            ...
                            <?php if (count($etudiants) > 0): ?>
                                <?php foreach ($etudiants as $etudiant): ?>
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="<?= "/pages/admin/etudiants/detail-etudiant.php?id=" . $etudiant['id'] ?>" class="btn btn-primary btn-sm rounded btn-icon"><i class="bi bi-eye"></i></a>
                                            <a href="<?= "/pages/admin/etudiants/edit-etudiant.php?id=" . $etudiant['id'] ?>" class="btn btn-warning btn-sm rounded btn-icon"><i class="bi bi-pencil-square"></i></a>
...
<div class="modal fade" id="addEtudiantModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        <form action="/etudiant/add" method="post" class="needs-validation" novalidate>    
