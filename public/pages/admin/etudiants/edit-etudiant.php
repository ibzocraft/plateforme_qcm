    ...
    <div class="bg-theme rounded-4 p-4 px-5 overflow-hidden">
        <div class="row justify-content-center align-items-center">
            <div class="col-6 bg-theme-accent rounded-4 p-3">
                ...
                <form action="/etudiant/edit" method="post" class="needs-validation" novalidate>
                    <div class="row g-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <a role="button" class="btn btn-danger fw-bold" href="<?= "/pages/admin/etudiants/etudiants.php" ?>">Quitter</a>
                        </div>
