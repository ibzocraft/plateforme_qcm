<?php
    ...
    require_once __DIR__ . '/../../../../includes/elements/crud-module-header.php';
...
<div class="container-fluid p-4">
    <!-- HEADER -->
    <?php crud_module_header(
        "Gestion des QCMs",
        "Gérez les QCMs de votre plateforme.",
        "Ajouter un QCM",
        "#addQcmModal"
    ); ?>
    <!-- /HEADER -->
    ...
    <div class="bg-theme rounded-4 p-3 overflow-hidden">
        <div class="d-flex flex-column">
            <div class="px-4 py-3 spawn-slide-down">
                <div class="input-group flex-nowrap">
                    <span class="input-group-text bg-theme-accent border-end-0"><i class="bi bi-search text-dark"></i></span>
                    <input type="text" id="searchQcm" class="form-control bg-theme-accent border-start-0" placeholder="Rechercher des QCMs par titre ou description..." aria-label="Search QCM" aria-describedby="addon-wrapping">
                </div>
            </div>
            <div class="px-4 py-3 spawn-slide-up slow">
                <div class="table-responsive bg-theme-accent rounded p-3">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-dark fw-semibold" style="width: 50%;">Description</th>
                                <th scope="col" class="text-secondary fw-semibold" style="width: 10%;">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if ($qcms): ?>
                                <?php foreach ($qcms as $qcm): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo "/pages/admin/qcms/detail-qcm.php?id=" . $qcm['id']; ?>" class="btn btn-sm btn-primary btn-icon">
                                                <i class="bi bi-eye"></i>
                                            </a>
...
<div class="modal fade" id="addQcmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <form action="/qcm/add" method="post" class="needs-validation" novalidate>
...
<div class="modal fade" id="editQcmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <form action="/qcm/edit" method="post" class="needs-validation" novalidate>
...
<div class="modal fade" id="deleteQcmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <form action="/qcm/delete" method="post">
