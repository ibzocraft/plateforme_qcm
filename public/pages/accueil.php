...
<div class="container-fluid pb-4">
    <div class="d-flex flex-column">
        <!-- Hero Section -->
        <div class="mt-3 mx-3">
            <div class="hero-section d-flex flex-column justify-content-end gap-4 p-4 rounded-3 rounded-bottom-4"
                ...
                <div class="d-flex flex-wrap gap-3">
                    <button class="btn btn-custom-1 rounded-pill px-4" onclick="window.location.href='<?= "/pages/auth/inscription.php" ?>'">
                        <span class="text-truncate">Commencer</span>
                    </button>
                    <button class="btn btn-custom-2 rounded-pill px-4" onclick="window.location.href='<?= "/pages/a-propos.php" ?>'">
